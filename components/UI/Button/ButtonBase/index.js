 ...
 */
const ButtonBase = ({ theme, className, contained, children, ...rest }) => (
  <>
    <button className={clsx('button-base', className)} {...rest}>
      {children}
    </button>
    <style jsx>{`
      .button-base {
        ...
        border: 1px solid
          ${contained
            ? 'transparent'
            : 'rgba(var(--palette-primary-main-rgb), 0.5)'};
      ...
      .button-base:hover {
        ...
        border: 1px solid
          ${contained ? 'transparent' : 'var(--palette-primary-main)'};
        background-color: ${contained
          ? 'var(--palette-primary-dark)'
          : 'rgba(var(--palette-primary-main-rgb), 0.08)'};
      }
