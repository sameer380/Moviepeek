...
const Backdrop = ({ theme, className, opened, ...rest }) => (
  <>
    <div
      className={clsx(CLASS_NAME, { [OPENED_CLASS_NAME]: opened }, className)}
      {...rest}
    />
    <style jsx>{`
      .${CLASS_NAME} {
        ...
        transition: opacity ${theme.transitions.duration.leavingScreen}ms
