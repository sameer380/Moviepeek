...
const Title = ({ theme, size = SIZE_TYPES.MEDIUM, children }) => (
  <>
...
const Subtitle = ({ theme, size, children }) => (
  <>
...
const Header = ({ theme, title, subtitle, size, className, ...rest }) => (
  <>
    <div {...rest} className={clsx('header', className)}>
